...
public class TC76 extends TestBase {
    ...
    @Test(description = "User can filter tickets by choosing Arrive Station and incorrect Depart Date")
    public void TC01() {
        ...
        System.out.println("Step 9: Verify Malformed Date Error Message Display");
    ...
    public void TC02() {
        ...
        String confirmPassword = password;
        String pid = Utilities.getPidRandom();
        String departDate = Utilities.getDepartDate(19);
        registerPage.register(username, password, confirmPassword, pid);
