...
public class TC81 extends TestBase {
    ...
    @Test(description = "User can filter tickets by choosing Depart Station, Status and correct Depart Date")
    public void TC01() {
        ...
        System.out.println("Step 7: Choosing Depart Station");
    ...
    @Test(description = "User can filter tickets by choosing Status and correct Depart Date and Depart Station")
    public void TC02() {
