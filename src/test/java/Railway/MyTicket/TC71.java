...
public class TC71 extends TestBase {
    ...
    @Test(description = "User can filter tickets by choosing Depart Station and correct Depart Date")
    public void TC01() {
        ...
        String departDate = Utilities.getDepartDate(9);
