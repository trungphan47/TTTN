...
public class TC82 extends TestBase {
    ...
    @Test(description = "User can filter tickets by choosing Depart Station, Status and incorrect Depart Date")
    public void TC01() {
    ...
    @Test(description = "User can filter tickets by choosing Depart Station, Status and incorrect Depart Date and Depart Station")
    public void TC02() {
        ...
        String confirmPassword = password;
        String pid = Utilities.getPidRandom();
        String departDate = Utilities.getDepartDate(16);
        registerPage.register(username, password, confirmPassword, pid);
